...
/* harmony import */ var _alert_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./alert.js */ "./public/js/alert.js");
...
//Axios is used to make http requests from the browser to the server
 ...
 //importing the showAlert function from the alerts.js file
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0,axios__WEBPACK_IMPORTED_MODULE_1__["default"])({
            ...
            //since we are hosting the api and the website on the same server
            data: {
              email: email,
              password: password
            },
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0,_alert_js__WEBPACK_IMPORTED_MODULE_0__.showAlert)('success', 'Logged in successfully!');
        ...
        case 7:
          ...
          (0,_alert_js__WEBPACK_IMPORTED_MODULE_0__.showAlert)('error', _context.t0.response.data.message);
        case 10:
        case "end":
...
var displayMap = function displayMap(locations) {
  var map = new maplibregl.Map({
    container: 'map',
    style: 'https://api.maptiler.com/maps/outdoor-v2/style.json?key=WgUUlo7MhekUD36G7RGz',
    scrollZoom: false
  });
...
/* harmony import */ var _login_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./login.js */ "./public/js/login.js");
/* harmony import */ var _maplibre_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./maplibre.js */ "./public/js/maplibre.js");
/* eslint-disable */
...
if (mapElement) {
  ...
  (0,_maplibre_js__WEBPACK_IMPORTED_MODULE_2__.displayMap)(locations);
}
if (loginForm) {
